...
export class AddBoardColumnsTable1705396987716 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "board_columns" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "order" integer NOT NULL, "board_id" uuid, CONSTRAINT "PK_c8d8f7690d5c6eb968d16abbb55" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
