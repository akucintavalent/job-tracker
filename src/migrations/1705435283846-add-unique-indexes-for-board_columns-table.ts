...
export class AddUniqueIndexesForBoardColumns1705435283846 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "board_columns" DROP CONSTRAINT "UN_NAME_PER_BOARD"`);
